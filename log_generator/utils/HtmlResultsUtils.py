...
def start_failed_test_error_table():
    return "<div class=\"failed-test-exceptions-table\">"
...
def add_error_cell_light(text):
    return "<div class=\"failed-test-exceptions-light\">{}</div>".format(text)


def add_error_cell_dark(text):
    return "<div class=\"failed-test-exceptions-dark\">{}</div>".format(text)
...
def start_rerun_test_error_table():
    return "<div class=\"rerun-test-exceptions-table\">"
...
def add_rerun_error_cell_light(text):
    return "<div class=\"rerun-test-exceptions-light\">{}</div>".format(text)


def add_rerun_error_cell_dark(text):
    return "<div class=\"rerun-test-exceptions-dark\">{}</div>".format(text)
